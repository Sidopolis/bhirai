...
const Cubes: React.FC<CubesProps> = ({
  ...
  const tiltAt = useCallback(
    (rowCenter: number, colCenter: number) => {
      ...
      (sceneRef.current.querySelectorAll(".cube") as NodeListOf<HTMLDivElement>).forEach((cube: HTMLDivElement) => {
      ...
      Object.keys(rings)
        ...
        .forEach((ring) => {
          ...
          const faces = rings[ring].flatMap((cube) =>
            Array.from(cube.querySelectorAll(".cube-face") as NodeListOf<HTMLDivElement>)
          );
        ...
        {cells.map((_, r) =>
          cells.map((__, c) => (
            <div key={`${r}-${c}`} className="cube" data-row={r} data-col={c}>
              ...
              {!onlyFrontFace && <><div className="cube-face cube-face--top" />
